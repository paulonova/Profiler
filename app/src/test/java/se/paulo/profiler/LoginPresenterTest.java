...
public class LoginPresenterTest {
    ...
    public void SetUp() throws Exception {
        ...
        presenter = new LoginPresenter(authSource, view,  SchedulerInjection.provideSchedulerProvider());
    ...
    public void whenLogInAuthFails () throws Exception {
        ...
        Mockito.when(authSource.attemptLogin(cred)).thenReturn(Completable.error(new Exception()));
